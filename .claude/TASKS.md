...
- **M4**: Phase2 完了（P2-T1〜T7） — 🚧 進行中（P2-T6 チュートリアル未完了。P2-T7 完了）
...
**プロンプト**: `archive/task-prompts/P2-T6-prompt.md`

---

### 残タスク一覧

#### P2-T6: チュートリアル（M4 達成にはこれが最後）
- **入力**: future-phases.md P2-T6。**依存: なし**
- **作業**: 初回起動時にチュートリアルオーバーレイを表示（操作説明・生産切替）。
- **補足**: P2-T7 完了に伴い、`Tutorial.svelte` の勝利条件文言を「80% の都市を支配 or 全ユニットを殲滅で勝利」とすること（旧「全都市を占領」は廃止）。
- **ディレクトリ**: `apps/web`（1 ディレクトリ）
- **見積**: 2h
- **プロンプト**: `archive/task-prompts/P2-T6-prompt.md`
