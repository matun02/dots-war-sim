...
### 次々タスク: P2-T7 勝利条件 80% + 影響マップ都市重み

**入力**: DESIGN.md §1.1。**依存: P2-T2**

**作業内容**:
- `evaluate-game-end.ts` の domination 判定を 80% 閾値に変更
- `influence-map.ts` の都市重み（city_weight=300）は実装済みのため確認のみ
